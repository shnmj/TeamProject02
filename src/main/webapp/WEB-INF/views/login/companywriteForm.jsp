					...
					<div class="mb-2">
						<form id="registerForm" action="/company/write" method="POST">
							<div class="form_list">
								...
								<div class="form_item" >
									<input type="password" class="input" name="com_passwd" 
									       placeholder="비밀번호"> 
									       
								</div>
								<div class="form_item" >
									<input class="password" type="email"  id="com_passwd_detail"
									       placeholder="비밀번호 확인">
								</div>
							...
							<div class="form_list">
								<div class="form_item" >
									<input class="input" type="text"  name="com_name" 
									       placeholder="회사이름">
									       
								</div>
								<div class="form_item" >
									<input class="input" type="text"  name="com_ceo" 
									       placeholder="대표자이름">
									       
								</div>
								
								<div class="form_item" >
									<input class="input" type="text"  name="com_phone"
									       placeholder="전화 번호">
								</div>
							...
							<div class ="address"> 
                    		  ...
                    		  <input type="hidden" name="com_address" id="com_address" value="">
                            </div> 
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function(){
    	   ...
    	   // 이름 입력 필드 선택
        let comEmailEl = document.querySelector('[name="com_email"]');
        let emailFormItem = comEmailEl.closest('.form_item');
        function checkEmail(){
    		let email = comEmailEl.value;
    	...
    	comEmailEl.addEventListener('blur', checkEmail);
    	   
    	
    	
    	function checkPassword1(){
    		// 1. 비밀번호 입력창 정보 가져오기
        	let PasswordEl = document.querySelector('[name="com_passwd"]'); 
    	...
    	function checkPassword2(){
        	...
        	let PasswordRetypeEl = document.querySelector('#com_passwd_detail'); 
		...
		function isMatch (password1, password2) {
		 ...
		 let comNameEl = document.querySelector('[name="com_name"]');
		    let nameFormItem = comNameEl.closest('.form_item');
		    
		    function checkName(){
		        let name = comNameEl.value;
		    ...
		    comNameEl.addEventListener('blur', checkName);
    ...
    document.getElementById('com_address').value = combinedAddress;
